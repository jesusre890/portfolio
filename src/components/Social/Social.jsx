    ...
    <div>
      <div className="social-links">
        <div id="gmail" className="social-btn flex-center">
          ...
          <span>
            <a href="mailto:jesusre890@gmail.com" className="text-red-500 font-semibold">jesusre890</a>
          </span>
        </div>
        ...
        <div id="linkedin" className="social-btn flex-center">
          ...
          <span>
            <a href="https://www.linkedin.com/in/jesus-re/" target="_blank" className="font-semibold text-cyan-700">
              jesusre
            </a>
          </span>
        </div>
        <div id="github" className="social-btn flex-center">
          ...
          <span>
            <a href="https://github.com/jesusre890" target="_blank" className="font-semibold text-zinc-700">jesusre890</a>
          </span>
        </div>
      </div>
    </div>
